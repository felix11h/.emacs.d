...
`MODE' should be set to either 'light or 'dark."
  ...
  `(let* ((srgb color-theme-sanityinc-solarized-rgb-is-srgb)
          ...
          (normal (if srgb "#d33682" "#c61b6e")) ; (0.7774 0.1080 0.4352)
...
names to which it refers are bound."
  (quote
   `(;; Standard font lock faces
     ...
     (font-lock-doc-face ((,class (:foreground ,normal))))
     (font-lock-doc-string-face ((,class (:foreground ,yellow))))
     (font-lock-function-name-face ((,class (:foreground ,blue))))
     (font-lock-keyword-face ((,class (:foreground ,green))))
     (font-lock-negation-char-face ((,class (:foreground ,green))))
     (font-lock-preprocessor-face ((,class (:foreground ,normal))))
     (font-lock-regexp-grouping-backslash ((,class (:foreground ,normal))))
     ...
     (clojure-java-call ((,class (:foreground ,normal))))
     ...
     ;; IDO
     (ido-subdir ((,class (:foreground ,normal))))
     ...
     ;; Emacs interface
     (cursor ((,class (:background ,normal))))
     (fringe ((,class (:background ,alt-background))))
     (linum ((,class (:background ,alt-background :foreground ,faint))))
     ...
     (show-paren-mismatch ((,class (:background ,normal :foreground ,background))))
     ...
     (slime-repl-prompt-face ((,class (:underline nil :weight bold :foreground ,normal))))
     ...
     (diff-hunk-header ((,class (:foreground ,normal))))
     ...
     (diredp-other-priv ((,class (:background nil :foreground ,normal))))
     ...
     (magit-log-head-label-local ((,class (:foreground ,normal :box nil :weight bold))))
     ...
     (term-color-normal ((,class (:background ,normal :foreground ,normal))))
     ...
     (eshell-ls-symlink ((,class (:foreground ,normal :weight normal))))
     ...
     (js2-external-variable-face ((,class (:foreground ,normal))))
     ...
     (js3-external-variable-face ((,class (:foreground ,normal))))
     (js3-function-param-face ((,class (:foreground ,blue))))
     (js3-jsdoc-tag-face ((,class (:foreground ,normal))))
     ...
     (message-separator ((,class (:foreground ,normal))))
     ...
     (ledger-font-payee-uncleared-face ((,class (:foreground ,cyan))))
     (ledger-font-posting-account-cleared-face ((,class (:foreground ,blue))))
     (ledger-font-posting-account-face ((,class (:foreground ,violet))))
     ...
     (term-color-normal ((,class (:foreground ,normal :background ,normal))))
    ...
    `(progn
       ...
       (color-theme-sanityinc-solarized--with-colors
        ...
        (custom-theme-set-variables
         ...
         `(ansi-color-names-vector (vector ,normal ,red ,green ,yellow ,blue ,normal ,cyan ,background))
  ...
  (if (fboundp 'load-theme)
    ...
    (progn
      ...
      (color-theme-sanityinc-solarized--with-colors
       ...
       (setq ansi-color-names-vector (vector normal red green yellow blue normal cyan background))
